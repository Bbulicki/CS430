...
Note: I have included both an executable and python script.  Both Scripts have worked for me, in tux the python script needs to be called by ./CG_hw3.py
...
Program Features:
    - All Features Implemented from HW1
        ...
        - Accepts and implements y-bounds using -b (lower) and -d (upper)
