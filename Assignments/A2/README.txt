...
Note: I have included both an execuateable and python script.  Both Scripts have worked for me, in tux the python script needs to be called by ./CG_hw2.py
